        ...
        >
            <div className="max-w-2xl mx-auto bg-white shadow-lg rounded-lg overflow-hidden">
                <div className="bg-green-600 p-6">
                    ...
                    <p className="text-green-100 text-center">Plan your farming
                ...
                <div className="p-6 space-y-6">
                    ...
                    <button
                        ...
                        className="w-full bg-green-600 text-white py-3 rounded-mdhover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-opacity-50 transition duration-200 ease-in-out transform hover:-translate-y-1 hover:shadow-lg disabled:opacity-50 disabled:cursor-not-allowed"
                        disabled={isLoading || !formData.landSize ||
                            !formData.cropType || !formData.soilType || !formData.season}
                    >
                        {isLoading ? (
                            <>
                ...
                {prediction && (
                    <div className="p-6 bg-green-50 border-t-2 border-green-200 ">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <PredictionItem icon={<Sprout />} label="Fertilizer"
                                value={prediction.fertilizer} />
                            <PredictionItem icon={<Droplet />} label="Water"
                                value={prediction.water} />
                            <PredictionItem icon={<Wheat />} label="Seeds"
                                value={prediction.seeds} />
                            <PredictionItem icon={<Bug />} label="Pesticide"
                                value={prediction.pesticide} />
                            <PredictionItem icon={<Flask />} label="Nutrients"
                                value={prediction.nutrients} />
                        </div>
                    </div>
                )}
            </div>
