...
function GetStartedTodaySection() {
  ...
  const items = [
    {
      title: t("Income / Weather Prediction"), // Use translation
      description: t("AI-powered forecasts for weather conditions and crop yield, helping farmers estimate income and plan efficiently."),
      link: "predict-income&weather",
      icon: <FaCloud className="text-4xl text-green-500 animate-pulse" />,
    },
    {
      title: t("Crop Needs Prediction"), // Use translation
      description: t("Predicts fertilizer, water, seed, pesticide, and nutrient requirements for your crops based on land size, crop type, etc."),
      link: "agricultural-needs",
      icon: <FaMoneyBillAlt className="text-4xl text-green-500 animate-bounce" />,
    },
    {
      title: t("Crop Price Forecasting"), // Use translation
      description: t("Predict the price of crops based on the current market trends and seasonal effects to estimate profits effectively."),
      link: "crop-price-forecast",
      icon: <FaChartLine className="text-4xl text-green-500 animate-pulse" />,
    },
    {
      title: t("Loan Recommendation"), // Use translation
      description: t("Receive tailored loan recommendations based on your financial health and business needs."),
    ...
    >
      <div className="container mx-auto px-6">
        <h2 className="text-4xl font-bold text-center mb-12 animate__animated animate__fadeIn">
          {t("Get Started Today")} {/* Use translation */}
        </h2>
