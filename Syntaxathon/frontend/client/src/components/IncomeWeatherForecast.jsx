...
const TabButton = ({ active, onClick, children, icon }) => (
  <button
    onClick={onClick}
    className={`flex items-center px-6 py-2 rounded-md font-semibold transition-colors duration-200 ${
      active ? "bg-green-500 text-white" : "bg-green-200 text-green-800 hover:bg-green-300"
    }`}
  >
    {icon}
    {children}
